...
"[project]/node_modules/@pipecat-ai/daily-transport/node_modules/@daily-co/daily-js/dist/daily-esm.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@pipecat-ai/daily-transport/dist/index.module.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "DailyRTVIMessageType",
    ()=>$683f111f61e07358$export$ef180de88fd317cc,
    "DailyTransport",
    ()=>$683f111f61e07358$export$b1ca982aa1e488c1
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$daily$2d$transport$2f$node_modules$2f40$daily$2d$co$2f$daily$2d$js$2f$dist$2f$daily$2d$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@pipecat-ai/daily-transport/node_modules/@daily-co/daily-js/dist/daily-esm.js [app-client] (ecmascript)");
...
$58d19ff082af5e5c$exports = JSON.parse("{\"name\":\"@pipecat-ai/daily-transport\",\"version\":\"1.2.0\",\"license\":\"BSD-2-Clause\",\"main\":\"dist/index.js\",\"module\":\"dist/index.module.js\",\"types\":\"dist/index.d.ts\",\"source\":\"src/index.ts\",\"repository\":{\"type\":\"git\",\"url\":\"git+https://github.com/pipecat-ai/pipecat-client-web-transports.git\"},\"files\":[\"dist\",\"package.json\",\"README.md\"],\"scripts\":{\"build\":\"parcel build --no-cache\",\"dev\":\"parcel watch\",\"lint\":\"eslint . --ext ts --report-unused-disable-directives --max-warnings 0\"},\"devDependencies\":{\"@pipecat-ai/client-js\":\"^1.2.0\",\"eslint\":\"9.11.1\",\"eslint-config-prettier\":\"^9.1.0\",\"eslint-plugin-simple-import-sort\":\"^12.1.1\"},\"peerDependencies\":{\"@pipecat-ai/client-js\":\"~1.2.0\"},\"dependencies\":{\"@daily-co/daily-js\":\"^0.77.0\"},\"description\":\"Pipecat Daily Transport Package\",\"author\":\"Daily.co\",\"bugs\":{\"url\":\"https://github.com/pipecat-ai/pipecat-client-web-transports/issues\"},\"homepage\":\"https://github.com/pipecat-ai/pipecat-client-web-transports/blob/main/transports/daily-webrtc/README.md\"}");
...
class $683f111f61e07358$export$b1ca982aa1e488c1 extends (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$client$2d$js$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Transport"]) {
    constructor(opts = {}){
        super();
        this._botId = "";
        this._selectedCam = {};
        ...
        this._daily = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$daily$2d$transport$2f$node_modules$2f40$daily$2d$co$2f$daily$2d$js$2f$dist$2f$daily$2d$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]).createCallObject({
    ...
    flushAudioQueue() {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$client$2d$js$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"]).debug(`Will flush audio queue: ${this._audioQueue.length}`);
    ...
    initialize(options, messageHandler) {
        ...
        if (this._dailyFactoryOptions.startVideoOff == null || options.enableCam != null) this._dailyFactoryOptions.startVideoOff = !(options.enableCam ?? false);
        if (this._dailyFactoryOptions.startAudioOff == null || options.enableMic != null) this._dailyFactoryOptions.startAudioOff = !(options.enableMic ?? true);
        this.attachEventListeners();
        this.state = "disconnected";
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$client$2d$js$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"]).debug("[Daily Transport] Initialized", (0, /*@__PURE__*/ $parcel$interopDefault($58d19ff082af5e5c$exports)).version);
    }
    get dailyCallClient() {
    ...
    updateSpeaker(speakerId) {
        this._daily.setOutputDeviceAsync({
            ...
            this._callbacks.onDeviceError?.(new (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$client$2d$js$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DeviceError"])([
                "speaker"
    ...
    async startRecording() {
        try {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$client$2d$js$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"]).info("[Daily Transport] Initializing recording");
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$client$2d$js$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"]).info("[Daily Transport] Recording Initialized");
        } catch (e) {
            const err = e;
            if (!err.message.includes("Already recording")) (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$client$2d$js$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"]).error("Error starting recording", e);
        }
    }
    ...
    async initDevices() {
        if (!this._daily) throw new (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$client$2d$js$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RTVIError"])("Transport instance not initialized");
    ...
    _validateConnectionParams(connectParams) {
        ...
        if (!tmpParams.token) delete tmpParams.token;
        return tmpParams;
    }
    async _connect(connectParams) {
        ...
        try {
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$client$2d$js$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"]).error("Failed to join room", e);
            this.state = "error";
        ...
        return new Promise((resolve)=>{
            ...
            const readyHandler = (ev)=>{
                if (!ev.participant?.local) {
                    ...
                    if (isIOS()) {
                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$client$2d$js$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"]).debug("[Daily Transport] iOS device detected, adding 0.5 second delay before sending ready message");
    ...
    async handleLocalAudioTrack(track) {
        ...
        switch(status){
            ...
            default:
                ...
                else (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$client$2d$js$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"]).warn("track-started event received for current track and already recording");
                break;
        }
    ...
    handleFatalError(ev) {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$client$2d$js$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"]).error("Daily fatal error", ev.errorMsg);
        this.state = "error";
        this._botId = "";
        this._callbacks.onError?.((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$client$2d$js$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RTVIMessage"]).error(ev.errorMsg, true));
    }
...
//# sourceMappingURL=node_modules_%40pipecat-ai_daily-transport_4b1be89d._.js.map