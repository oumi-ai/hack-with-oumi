...
"[project]/node_modules/@pipecat-ai/small-webrtc-transport/node_modules/@daily-co/daily-js/dist/daily-esm.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function Z(e) {
    return null != e && e.callObjectBundleUrlOverride ? e.callObjectBundleUrlOverride : X("https://c.daily.co/call-machine/versioned/".concat("0.77.0", "/static/call-machine-object-bundle.js"), e);
}
function ee(e) {
    try {
        new URL(e);
...
}), ue = "?", de = /\(error: (.*)\)/, pe = /captureMessage|captureException/;
function he(e) {
    return e[e.length - 1] || {};
}
const fe = "<anonymous>";
...
function hn(e, t, n, r) {
    const i = pn(n), o = e.type && "replay_event" !== e.type ? e.type : "event";
    !function(e, t) {
...
function bn(e, t) {
    ...
    _n(e, "extra", n), _n(e, "tags", r), _n(e, "user", i), _n(e, "contexts", o), e.sdkProcessingMetadata = bt(e.sdkProcessingMetadata, a, 2), s && (e.level = s), h && (e.transactionName = h), f && (e.span = f), c.length && (e.breadcrumbs = [
        ...e.breadcrumbs,
        ...c
...
function wn(e, t, n, r, i, o) {
    ...
    const d = i ? i.getEventProcessors() : [], p = ie("globalScope", ()=>new Mt).getScopeData();
    if (o) {
        bn(p, o.getScopeData());
    }
    if (u) {
    ...
    h.length && (n.attachments = h), yn(c, p);
    return fn([
        ...d,
        ...p.eventProcessors
...
class Dn {
    ...
    flush(e) {
        ...
        return t ? (this.emit("flush"), this._isClientDoneProcessing(e).then((n)=>t.flush(e).then((e)=>n && e))) : pt(!0);
    }
    close(e) {
    ...
    sendEnvelope(e) {
        return this.emit("beforeEnvelope", e), this._isEnabled() && this._transport ? this._transport.send(e).then(null, (e)=>(te && le.error("Error while sending envelope:", e), e)) : (te && le.error("Transport disabled"), pt({}));
    }
    _setupIntegrations() {
    ...
    _processEvent(e, t, n) {
        ...
        if (s && "number" == typeof l && Math.random() > l) return this.recordDroppedEvent("sample_rate", "error", e), ht(new xn(`Discarding event because it's not included in the random sample (sampling rate = ${i})`, "log"));
...
function Fn(e) {
    ...
    return {
        $: t,
        add: function(r) {
            if (!(void 0 === e || t.length < e)) return ht(new xn("Not adding Promise because buffer limit was reached."));
            const i = r();
    ...
    return {
        send: function(i) {
            ...
            return n.add(()=>t({
                ...
                if (e instanceof xn) return te && le.error("Skipped sending event because buffer is full."), a("queue_overflow"), pt({});
                throw e;
            });
        },
        flush: (e)=>n.drain(e)
                ...
                return function(...n) {
                    const r = new Error, { method: i, url: o } = function(e) {
                        ...
                        if (2 === e.length) {
                            ...
                            return {
                                url: hr(t),
                                method: pr(n, "method") ? String(n.method).toUpperCase() : "GET"
                            };
                        }
                        const t = e[0];
                        return {
                            url: hr(t),
                            method: pr(t, "method") ? String(t.method).toUpperCase() : "GET"
                        };
                    }(n), s = {
                        args: n,
                        fetchData: {
                    ...
                    return e || we("fetch", {
                        ...s
                    }), t.apply(re, n).then(async (t)=>(("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : we("fetch", {
                            ...s,
                            endTimestamp: 1e3 * it(),
                            response: t
                        }), t), (e)=>{
...
function hr(e) {
    return "string" == typeof e ? e : e ? pr(e, "url") ? e.url : e.toString ? e.toString() : "" : "";
}
const fr = re;
const vr = re;
let gr = 0;
...
class jr extends Dn {
    ...
    eventFromException(e, t) {
        return function(e, t, n, r) {
            ...
            return lt(i), i.level = "error", n && n.event_id && (i.event_id = n.event_id), pt(i);
...
const Gr = /^\s*at (\S+?)(?::(\d+))(?::(\d+))\s*$/i, Qr = /^\s*at (?:(.+?\)(?: \[.+\])?|.*?) ?\((?:address at )?)?(?:async )?((?:<anonymous>|[-a-z]+:|.*bundle|\/)?.*?)(?::(\d+))?(?::(\d+))?\)?\s*$/i, Kr = /\((\S*)(?::(\d+))(?::(\d+))\)/, Yr = /^\s*(.*?)(?:\((.*?)\))?(?:^|@)?((?:[-a-z]+)?:\/.*?|\[native code\]|[^@]*(?:bundle|\d+\.js)|\/[\w\-. /=]+)(?::(\d+))?(?::(\d+))?\s*$/i, Xr = /(\S+) line (\d+)(?: > eval line \d+)* > eval/i, Zr = function(...e) {
    ...
    return (e, n = 0, r = 0)=>{
        ...
        return function(e) {
            ...
            t.reverse(), pe.test(he(t).function || "") && (t.pop(), pe.test(he(t).function || "") && t.pop());
        ...
        setup (e) {
            t.onerror && (!function(e) {
                !function(e) {
                    ...
                    const { stackParser: n, attachStacktrace: r } = pi();
                    if (xt() !== e || mr()) return;
...
var Ss = function() {
    try {
        var e = document.createElement("canvas"), t = null != (navigator.webdriver ? e.getContext("webgl2") : e.getContext("webgl2", {
...
function Cs() {
    return bs() && !function() {
        ...
        switch(t){
            case "Chrome":
                return (e = As()).major && e.major > 0 && e.major < 75;
            case "Firefox":
                return (e = Ls()).major < 91;
            case "Safari":
                return (e = xs()).major < 13 || 13 === e.major && e.minor < 1;
            default:
                return !0;
        }
    }();
...
function Os() {
    if ("undefined" != typeof window) {
        var e = ms();
        return js() ? "Safari" : e.indexOf("Edge") > -1 ? "Edge" : e.match(/Chrome\//) ? "Chrome" : e.indexOf("Safari") > -1 || Is() ? "Safari" : e.indexOf("Firefox") > -1 ? "Firefox" : e.indexOf("MSIE") > -1 || e.indexOf(".NET") > -1 ? "IE" : "Unknown Browser";
    }
}
function Ps() {
    switch(Os()){
...
var Bs = function() {
    function e() {
        var n, r, i, o;
        return t(this, e), r = this, i = a(i = e), (n = s(r, Fs() ? Reflect.construct(i, o || [], a(r).constructor) : i.apply(r, o)))._wrappedListeners = {}, n._messageCallbacks = {}, n;
    }
    return l(e, Ds), o(e, [
        {
            key: "addListenerForMessagesFromCallMachine",
...
var Js = function() {
    function e() {
        var n, r, i, o;
        return t(this, e), r = this, i = a(i = e), n = s(r, Vs() ? Reflect.construct(i, o || [], a(r).constructor) : i.apply(r, o)), /*TURBOPACK member replacement*/ __turbopack_context__.g.callMachineToDailyJsEmitter = /*TURBOPACK member replacement*/ __turbopack_context__.g.callMachineToDailyJsEmitter || new I.EventEmitter, /*TURBOPACK member replacement*/ __turbopack_context__.g.dailyJsToCallMachineEmitter = /*TURBOPACK member replacement*/ __turbopack_context__.g.dailyJsToCallMachineEmitter || new I.EventEmitter, n._wrappedListeners = {}, n._messageCallbacks = {}, n;
    }
    return l(e, Ds), o(e, [
        {
            key: "addListenerForMessagesFromCallMachine",
...
}(), $s = "replace", qs = "shallow-merge", zs = [
    $s,
    qs
];
var Ws = function() {
    function e() {
        var n = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, r = n.data, i = n.mergeStrategy, o = void 0 === i ? $s : i;
    ...
    return o(e, [
    ...
    ], [
        {
            key: "isNoOpUpdate",
            value: function(e, t) {
                return 0 === Object.keys(e).length && t === qs;
            }
        },
        {
            key: "_validateMergeStrategy",
            value: function(e) {
                if (!zs.includes(e)) throw Error("Unrecognized mergeStrategy provided. Options are: [".concat(zs, "]"));
            }
        },
        {
            key: "_validateData",
...
var Ys = function() {
    return o(function e(n) {
    ...
    }, [
        {
            ...
            value: function() {
                ...
                e = this._callClientId, window._daily.pendings.push(e), this._currentLoad && this._currentLoad.cancel(), this._currentLoad = new Xs(n, function() {
                    r(!1);
                }, function(e, n) {
                    n || Ks(t._callClientId), i(e, n);
                ...
                if (!this._currentAttempt) {
                    var t = function(n) {
                        e._currentAttempt.cancelled || (e._attemptsRemaining--, e._failureCallback(n, e._attemptsRemaining > 0), e._attemptsRemaining <= 0 || setTimeout(function() {
                            e._currentAttempt.cancelled || (e._currentAttempt = new ta(e._dailyConfig, e._successCallback, t), e._currentAttempt.start());
                        }, 3e3));
                    };
                    this._currentAttempt = new ta(this._dailyConfig, this._successCallback, t), this._currentAttempt.start();
                }
            }
        },
        {
    ...
    function e() {
        return t(this, e), n = this, i = arguments, r = a(r = e), s(n, Qs() ? Reflect.construct(r, i || [], a(n).constructor) : r.apply(n, i));
        //TURBOPACK unreachable
        ;
        var n, r, i;
    }
    return l(e, Gs(Error)), o(e);
}(), ea = 2e4, ta = function() {
    return o(function e(n, r, i) {
        t(this, e), this._loadAttemptImpl = ys() || !n.avoidEval ? new na(n, r, i) : new ra(n, r, i);
    }, [
        {
            key: "start",
            value: (e = p(function*() {
            ...
            value: (n = p(function*(e) {
                ...
                this._networkTimeout = setTimeout(function() {
                    t._networkTimedOut = !0, t._failureCallback({
                        msg: "Timed out (>".concat(ea, " ms) when loading call object bundle ").concat(e),
                        type: "timeout"
                    });
                }, ea);
                try {
                    ...
                    if (clearTimeout(this._networkTimeout), t instanceof Zs || this.cancelled || this._networkTimedOut) return;
...
function ua(e, t) {
    for(var n = t.getState(), r = 0, i = [
        ...
        if (u) {
            var d = e.local ? oa(n, o, c) : sa(n, e.session_id, o, c);
...
function da(e, t) {
    try {
        var n = t.getState();
        for(var r in e.tracks)if (!pa(r)) {
            var i = e.tracks[r].kind;
            if (i) {
                var o = e.tracks[r];
                if (o) {
                    var s = e.local ? la(n, r) : sa(n, e.session_id, r, i);
...
function ha(e, t, n) {
    ...
    if (e.local) {
        ...
        try {
            r.streams;
            if (e.audio && ia(r, e.session_id, "cam-audio")) {
                var s = sa(r, e.session_id, "cam", "audio");
                s && (t && t.audioTrack && t.audioTrack.id === s.id ? e.audioTrack = s : s.muted || (e.audioTrack = s)), e.audioTrack || (e.audio = !1);
            }
            if (e.video && ia(r, e.session_id, "cam-video")) {
                var a = sa(r, e.session_id, "cam", "video");
                a && (t && t.videoTrack && t.videoTrack.id === a.id ? e.videoTrack = a : a.muted || (e.videoTrack = a)), e.videoTrack || (e.video = !1);
            }
            if (e.screen && ia(r, e.session_id, "screen-audio")) {
                var c = sa(r, e.session_id, "screen", "audio");
                c && (t && t.screenAudioTrack && t.screenAudioTrack.id === c.id ? e.screenAudioTrack = c : c.muted || (e.screenAudioTrack = c));
            }
            if (e.screen && ia(r, e.session_id, "screen-video")) {
                var l = sa(r, e.session_id, "screen", "video");
...
var _a = new Map, wa = null;
function Sa(e) {
    Ma() ? function(e) {
        ga.has(e) || (ga.set(e, {}), navigator.mediaDevices.enumerateDevices().then(function(t) {
            ga.has(e) && (ga.get(e).lastDevicesString = JSON.stringify(t), ma || (ma = function() {
                var e = p(function*() {
                    var e, t = yield navigator.mediaDevices.enumerateDevices(), n = fa(ga.keys());
                    try {
                        for(n.s(); !(e = n.n()).done;){
                            var r = e.value, i = JSON.stringify(t);
                            i !== ga.get(r).lastDevicesString && (ga.get(r).lastDevicesString = i, r(t));
                        }
                    } catch (e) {
                        n.e(e);
                    } finally{
        ...
        _a.has(e) || (_a.set(e, {}), navigator.mediaDevices.enumerateDevices().then(function(t) {
            _a.has(e) && (_a.get(e).lastDevicesString = JSON.stringify(t), wa || (wa = setInterval(p(function*() {
                var e, t = yield navigator.mediaDevices.enumerateDevices(), n = ya(_a.keys());
                try {
                    for(n.s(); !(e = n.n()).done;){
                        var r = e.value, i = JSON.stringify(t);
                        i !== _a.get(r).lastDevicesString && (_a.get(r).lastDevicesString = i, r(t));
                    }
                } catch (e) {
                    n.e(e);
                } finally{
...
function ka(e) {
    Ma() ? function(e) {
        ga.has(e) && (ga.delete(e), 0 === ga.size && ma && (navigator.mediaDevices.removeEventListener("devicechange", ma), ma = null));
    }(e) : function(e) {
        _a.has(e) && (_a.delete(e), 0 === _a.size && wa && (clearInterval(wa), wa = null));
    }(e);
}
function Ma() {
    var e;
...
function Ea(e, t) {
    ...
    return e && "live" === e.readyState && !function(e, t) {
        return (!t.isLocalScreenVideo || "Chrome" !== Os()) && e.muted && !Ca.has(e.id);
    }(e, {
...
Object.freeze(ja.reduce(function(e, t, n) {
    return e[t] = Ia[n], e;
}, {})), Object.freeze(Ia.reduce(function(e, t, n) {
    return e[t] = ja[n], e;
}, {}));
var xa = [
    Pa.VIDEO,
    ...
    return o(e, [
        {
            ...
            value: function() {
                var t = new e;
                if (this.base instanceof Ra ? t.base = this.base.clone() : t.base = this.base, void 0 !== this.byUserId) for(var n in t.byUserId = {}, this.byUserId){
                    var r = this.byUserId[n];
                    t.byUserId[n] = r instanceof Ra ? r.clone() : r;
                }
                if (void 0 !== this.byParticipantId) for(var i in t.byParticipantId = {}, this.byParticipantId){
                    var o = this.byParticipantId[i];
                    t.byParticipantId[i] = o instanceof Ra ? o.clone() : o;
                }
                return t;
            }
        },
        {
            ...
            value: function() {
                var e = {};
                if ("boolean" == typeof this.base ? e.base = this.base : this.base instanceof Ra && (e.base = this.base.toJSONObject()), void 0 !== this.byUserId) for(var t in e.byUserId = {}, this.byUserId){
                    var n = this.byUserId[t];
                    e.byUserId[t] = n instanceof Ra ? n.toJSONObject() : n;
                }
                if (void 0 !== this.byParticipantId) for(var r in e.byParticipantId = {}, this.byParticipantId){
                    var i = this.byParticipantId[r];
                    e.byParticipantId[r] = i instanceof Ra ? i.toJSONObject() : i;
                }
                return e;
            }
        },
        ...
        },
        {
            key: "normalize",
            value: function() {
                return this.base instanceof Ra && (this.base = this.base.normalize()), this.byUserId && (this.byUserId = Object.fromEntries(Object.entries(this.byUserId).map(function(e) {
                    var t = f(e, 2), n = t[0], r = t[1];
                    return [
                        n,
                        r instanceof Ra ? r.normalize() : r
                    ];
    ...
    ], [
        {
            ...
            value: function(t) {
                var n, r, i;
                if (void 0 !== t.base && (n = "boolean" == typeof t.base ? t.base : Ra.fromJSONObject(t.base)), void 0 !== t.byUserId) for(var o in r = {}, t.byUserId){
                    var s = t.byUserId[o];
                    r[o] = "boolean" == typeof s ? s : Ra.fromJSONObject(s);
                }
                if (void 0 !== t.byParticipantId) for(var a in i = {}, t.byParticipantId){
                    var c = t.byParticipantId[a];
                    i[a] = "boolean" == typeof c ? c : Ra.fromJSONObject(c);
                }
                return new e({
                    base: n,
                    byUserId: r,
        ...
        },
        {
            ...
            value: function(t) {
                var n, r, i;
                if (void 0 !== t.b && (n = "boolean" == typeof t.b ? t.b : Ra.fromMinifiedJSONObject(t.b)), void 0 !== t.u) for(var o in r = {}, t.u){
                    var s = t.u[o];
                    r[o] = "boolean" == typeof s ? s : Ra.fromMinifiedJSONObject(s);
                }
                if (void 0 !== t.p) for(var a in i = {}, t.p){
                    var c = t.p[a];
                    i[a] = "boolean" == typeof c ? c : Ra.fromMinifiedJSONObject(c);
                }
                return new e({
                    base: n,
                    byUserId: r,
        ...
        },
        {
            ...
            value: function(e) {
                ...
                for(var t = [
                    ...
                    if ("base" === o) {
                        var s = f(Ra.validateJSONObject(e.base, !0), 2), a = s[0], c = s[1];
                        if (!a) return [
                            !1,
                            c
                        ];
                        ...
                        for(var l = 0, u = Object.values(e[o]); l < u.length; l++){
                            var d = u[l], p = f(Ra.validateJSONObject(d), 2), h = p[0], v = p[1];
                            if (!h) return [
                                !1,
                                v
                            ];
    ...
    return o(e, [
        {
            ...
            value: function() {
                var t = new e;
                return void 0 !== this.video && (t.video = this.video), void 0 !== this.audio && (t.audio = this.audio), void 0 !== this.screenVideo && (t.screenVideo = this.screenVideo), void 0 !== this.screenAudio && (t.screenAudio = this.screenAudio), void 0 !== this.customVideo && (t.customVideo = Oa({}, this.customVideo)), void 0 !== this.customAudio && (t.customAudio = Oa({}, this.customAudio)), t;
            }
        },
        {
            key: "toJSONObject",
            value: function() {
                var e = {};
                return void 0 !== this.video && (e.video = this.video), void 0 !== this.audio && (e.audio = this.audio), void 0 !== this.screenVideo && (e.screenVideo = this.screenVideo), void 0 !== this.screenAudio && (e.screenAudio = this.screenAudio), void 0 !== this.customVideo && (e.customVideo = Oa({}, this.customVideo)), void 0 !== this.customAudio && (e.customAudio = Oa({}, this.customAudio)), e;
            }
        },
        {
            key: "toMinifiedJSONObject",
            value: function() {
                var e = {};
                return void 0 !== this.video && (e.v = this.video), void 0 !== this.audio && (e.a = this.audio), void 0 !== this.screenVideo && (e.sv = this.screenVideo), void 0 !== this.screenAudio && (e.sa = this.screenAudio), void 0 !== this.customVideo && (e.cv = Oa({}, this.customVideo)), void 0 !== this.customAudio && (e.ca = Oa({}, this.customAudio)), e;
            }
        },
        {
            key: "normalize",
        ...
        },
        {
            ...
            value: function(t) {
                return new e({
                    ...
                    customVideo: void 0 !== t.customVideo ? Oa({}, t.customVideo) : void 0,
                    customAudio: void 0 !== t.customAudio ? Oa({}, t.customAudio) : void 0
                });
            }
        },
        {
        ...
        },
        {
            ...
            value: function(e, t) {
                ...
                return t && r.length !== ja.length ? [
                    !1,
                    'canReceive "base" permission must specify all media types: '.concat(ja.join(", "), " (or be set to a boolean shorthand)")
                ] : [
                    !0
                ];
            }
...
var Wa = "video", Ha = "voice", Ga = ys() ? {
    ...
    customTrayButtons: {
        validate: Cc,
        help: "customTrayButtons should be a dictionary of the type ".concat(JSON.stringify(ec))
    },
    url: {
        validate: function(e) {
    ...
    reactNativeConfig: {
        ...
        help: "reactNativeConfig should look like ".concat(JSON.stringify(Za), ", all fields optional")
    },
    lang: {
        validate: function(e) {
            return [
    ...
    inputSettings: {
        validate: function(e, t) {
            var n;
            return !!mc(e) && (t._inputSettings || (t._inputSettings = {}), yc(e, null === (n = t.properties) || void 0 === n ? void 0 : n.dailyConfig, t._sharedTracks), t._updatePreloadCacheInputSettings(e, !0), !0);
        },
        help: Sc()
    },
    layout: {
            ...
            for(var t = 0, n = Object.entries(e); t < n.length; t++){
                ...
                switch(i){
                    ...
                    case "canSend":
                        ...
                        break;
                    case "canReceive":
                        var u = f(Na.validateJSONObject(o), 2), d = u[0], p = u[1];
...
var ic = function() {
    function r(e) {
        ...
        if (t(this, r), o = this, c = a(c = r), u(i = s(o, Ja() ? Reflect.construct(c, l || [], a(o).constructor) : c.apply(o, l)), "startListeningForDeviceChanges", function() {
            Sa(i.handleDeviceChange);
        }), u(i, "stopListeningForDeviceChanges", function() {
            ka(i.handleDeviceChange);
            ...
            i.stopScreenShare();
        }), i.strictMode = void 0 === h.strictMode || h.strictMode, i.allowMultipleCallInstances = null !== (n = h.allowMultipleCallInstances) && void 0 !== n && n, Object.keys(za).length && (i._logDuplicateInstanceAttempt(), !i.allowMultipleCallInstances)) {
        ...
        if (window._daily || (window._daily = {
            pendings: [],
            instances: {}
        }), i.callClientId = K(), za[(d = i).callClientId] = d, window._daily.instances[i.callClientId] = {}, i._sharedTracks = {}, window._daily.instances[i.callClientId].tracks = i._sharedTracks, h.dailyJsVersion = r.version(), i._iframe = e, i._callObjectMode = "none" === h.layout && !i._iframe, i._preloadCache = {
            ...
            access: Oi
        }, i._meetingSessionSummary = {}, i._finalSummaryOfPrevSession = {}, i._meetingSessionState = jc(Ga, i._callObjectMode), i._nativeInCallAudioMode = Wa, i._participants = {}, i._isScreenSharing = !1, i._participantCounts = Qa, i._rmpPlayerState = {}, i._waitingParticipants = {}, i._network = {
            threshold: "good",
            quality: 100,
            networkState: "unknown",
            stats: {}
        }, i._activeSpeaker = {}, i._localAudioLevel = 0, i._isLocalAudioLevelObserverRunning = !1, i._remoteParticipantsAudioLevel = {}, i._isRemoteParticipantsAudioLevelObserverRunning = !1, i._maxAppMessageSize = rs, i._messageChannel = ys() ? new Js : new Bs, i._iframe && (i._iframe.requestFullscreen ? i._iframe.addEventListener("fullscreenchange", function() {
    ...
    return l(r, x), o(r, [
        {
            ...
            value: (ee = p(function*() {
                ...
                }), delete za[this.callClientId], (null === (e = window) || void 0 === e || null === (e = e._daily) || void 0 === e ? void 0 : e.instances) && delete window._daily.instances[this.callClientId], this.strictMode && (this.callClientId = void 0);
            }), function() {
        ...
        },
        {
            ...
            value: function(e) {
                ...
                return hc(), this.sendMessageToCallMachine({
                    action: "load-css",
        ...
        },
        {
            ...
            value: function(e, t) {
                for(var n in t){
                    if (!rc[n]) throw new Error("unrecognized updateParticipant property ".concat(n));
                    if (rc[n].validate && !rc[n].validate(t[n], this, this._participants[e])) throw new Error(rc[n].help);
                }
            }
        },
        {
        ...
        },
        {
            ...
            value: (Y = p(function*() {
                ...
                if (dc(this._callObjectMode, "updateWaitingParticipant()"), sc(this._callState, "updateWaitingParticipant()"), "string" != typeof t || "object" !== n(r)) throw new Error("updateWaitingParticipant() must take an id string and a updates object");
        ...
        },
        {
            ...
            value: (G = p(function*() {
                ...
                if (dc(this._callObjectMode, "updateWaitingParticipants()"), sc(this._callState, "updateWaitingParticipants()"), "object" !== n(t)) throw new Error("updateWaitingParticipants() must take a mapping between ids and update objects");
                return new Promise(function(n, r) {
                    e.sendMessageToCallMachine({
        ...
        },
        {
            ...
            value: (H = p(function*() {
                ...
                return dc(this._callObjectMode, "requestAccess()"), sc(this._callState, "requestAccess()"), new Promise(function(t, n) {
                    e.sendMessageToCallMachine({
        ...
        },
        {
            ...
            value: (z = p(function*(e) {
                var t = this;
                if (dc(this._callObjectMode, "updateReceiveSettings()"), !gc(e, {
                    allowAllParticipantsKey: !0
                })) throw new Error(kc({
                    allowAllParticipantsKey: !0
                }));
                return sc(this._callState, "updateReceiveSettings()", "To specify receive settings earlier, use the receiveSettings config property."), new Promise(function(n) {
                    t.sendMessageToCallMachine({
                ...
                if (e) {
                    ...
                    if (e.audio) {
                        ...
                        if (e.audio.processor && !s) {
                            var a = Va({}, e.audio.processor);
                            delete a._isDefaultWhenNone, n.audio = Va(Va({}, n.audio), {}, {
                                processor: a
                            });
                        }
                    }
                    if (e.video) {
                        ...
                        if (e.video.processor && !d) {
                            var p = Va({}, e.video.processor);
                            delete p._isDefaultWhenNone, n.video = Va(Va({}, n.video), {}, {
                                processor: p
                            });
                        }
                    }
        ...
        },
        {
            ...
            value: function() {
                var e = this;
                return hc(), new Promise(function(t) {
        ...
        },
        {
            ...
            value: function(e, t) {
                ...
                if (e.video) {
                    var i, o, s;
                    if (r.video = {}, e.video.settings) r.video.settings = {}, t || e.video.settings.customTrack || null === (s = n.video) || void 0 === s || !s.settings ? r.video.settings = e.video.settings : r.video.settings = Va(Va({}, n.video.settings), e.video.settings), Object.keys(r.video.settings).length || delete r.video.settings;
                ...
                if (e.audio) {
                    var a, c, l;
                    if (r.audio = {}, e.audio.settings) r.audio.settings = {}, t || e.audio.settings.customTrack || null === (l = n.audio) || void 0 === l || !l.settings ? r.audio.settings = e.audio.settings : r.audio.settings = Va(Va({}, n.audio.settings), e.audio.settings), Object.keys(r.audio.settings).length || delete r.audio.settings;
        ...
        },
        {
            ...
            value: (q = p(function*(e) {
                var t = this;
                return hc(), mc(e) ? e.video || e.audio ? (yc(e, this.properties.dailyConfig, this._sharedTracks), this._callObjectMode && !this._callMachineInitialized ? (this._updatePreloadCacheInputSettings(e, !0), this._getInputSettings()) : new Promise(function(n, r) {
                    t.sendMessageToCallMachine({
        ...
        },
        {
            ...
            value: function(e) {
                ...
                if (hc(), this._callMachineInitialized) return this.sendMessageToCallMachine({
        ...
        },
        {
            ...
            value: function() {
                var e = this;
                if (hc(), this._callMachineInitialized) return new Promise(function(t) {
                    e.sendMessageToCallMachine({
        ...
        },
        {
            ...
            value: ($ = p(function*() {
                var e = this;
                return console.warn("getMeetingSession() is deprecated: use meetingSessionSummary(), which will return immediately"), sc(this._callState, "getMeetingSession()"), new Promise(function(t) {
                    e.sendMessageToCallMachine({
        ...
        },
        {
            ...
            value: (V = p(function*() {
                ...
                if (dc(this._callObjectMode, "startCamera()"), cc(this._callState, this._isPreparingToJoin, "startCamera()", "Did you mean to use setLocalAudio() and/or setLocalVideo() instead?"), this.needsLoad()) try {
                    ...
                    this.validateProperties(t), this.properties = Va(Va({}, this.properties), t);
                }
                return new Promise(function(t) {
                    e._preloadCache.inputSettings = e._prepInputSettingsForSharing(e._inputSettings, !1), e.sendMessageToCallMachine({
                        action: "start-camera",
                        properties: oc(e.properties, e.callClientId),
                        preloadCache: oc(e._preloadCache, e.callClientId)
                    }, function(e) {
                        t({
                            camera: e.camera,
                            mic: e.mic,
        ...
        },
        {
            ...
            value: function() {
                ...
                return hc(), sc(this._callState, "startCustomTrack()"), this.validateCustomTrack(t.track, t.mode, t.trackName), new Promise(function(n, r) {
        ...
        },
        {
            ...
            value: function(e) {
                var t = this;
                return hc(), sc(this._callState, "stopCustomTrack()"), new Promise(function(n) {
                    t.sendMessageToCallMachine({
        ...
        },
        {
            ...
            value: function(e) {
                var t = this;
                return fc(), lc(this._callMachineInitialized, "setCamera()"), new Promise(function(n) {
                    t.sendMessageToCallMachine({
                        action: "set-camera",
                        cameraDeviceId: e
                    }, function(e) {
        ...
        },
        {
            ...
            value: (U = p(function*(e) {
                return fc(), this.nativeUtils().setAudioDevice(e), {
        ...
        },
        {
            ...
            value: function() {
                var e = this;
                return fc(), new Promise(function(t) {
                    e.sendMessageToCallMachine({
        ...
        },
        {
            ...
            value: (B = p(function*(e) {
                var t = this, n = e.audioDeviceId, r = e.videoDeviceId, i = e.audioSource, o = e.videoSource;
                if (hc(), void 0 !== i && (n = i), void 0 !== o && (r = o), "boolean" == typeof n && (this._setAllowLocalAudio(n), n = void 0), "boolean" == typeof r && (this._setAllowLocalVideo(r), r = void 0), !n && !r) return yield this.getInputDevices();
                var s = {};
        ...
        },
        {
            ...
            value: (F = p(function*(e) {
                var t = this, n = e.outputDeviceId;
                return hc(), n && (this._preloadCache.outputDeviceId = n), this._callObjectMode && this.needsLoad() ? this._devicesFromInputSettings(this._inputSettings) : new Promise(function(e) {
                    t.sendMessageToCallMachine({
        ...
        },
        {
            ...
            value: function(e) {
                if (fc(), [
                    ...
                    if (e !== this._nativeInCallAudioMode) return this._nativeInCallAudioMode = e, !this.disableReactNativeAutoDeviceManagement("audio") && ac(this._callState, this._isPreparingToJoin) && this.nativeUtils().setAudioMode(this._nativeInCallAudioMode), this;
        ...
        },
        {
            ...
            value: (D = p(function*() {
                var e = this, t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
                if (dc(this._callObjectMode, "preAuth()"), cc(this._callState, this._isPreparingToJoin, "preAuth()"), this.needsLoad() && (yield this.load(t)), !t.url) throw new Error("preAuth() requires at least a url to be provided");
                return this.validateProperties(t), this.properties = Va(Va({}, this.properties), t), new Promise(function(t, n) {
                    e._preloadCache.inputSettings = e._prepInputSettingsForSharing(e._inputSettings, !1), e.sendMessageToCallMachine({
        ...
        },
        {
            ...
            value: (L = p(function*(e) {
                ...
                if (this.needsLoad()) {
                    ...
                    if (e && (this.validateProperties(e), this.properties = Va(Va({}, this.properties), e)), !this._callObjectMode && !this.properties.url) throw new Error("can't load iframe meeting because url property isn't set");
        ...
        },
        {
            ...
            value: (I = p(function*() {
                ...
                return void 0 !== t.showLocalVideo && (this._callObjectMode ? console.error("showLocalVideo is not available in callObject mode") : this._showLocalVideo = !!t.showLocalVideo), void 0 !== t.showParticipantsBar && (this._callObjectMode ? console.error("showParticipantsBar is not available in callObject mode") : this._showParticipantsBar = !!t.showParticipantsBar), this._callState === bi || this._callState === yi ? (console.warn("already joined meeting, call leave() before joining again"), void this.updateIsPreparingToJoin(!1)) : (this._updateCallState(yi, !1), this.emitDailyJSEvent({
                    ...
                    action: "join-meeting",
                    properties: oc(this.properties, this.callClientId),
                    preloadCache: oc(this._preloadCache, this.callClientId)
                        ...
                        if (e._callState !== wi) {
                            if (e._updateCallState(bi), i) for(var s in i){
                                if (e._callObjectMode) {
                                    ...
                                    ua(i[s], a), da(i[s], a), ha(i[s], e._participants[s], a);
                                }
                                e._participants[s] = Va({}, i[s]), e.toggleParticipantAudioBasedOnNativeAudioFocus();
                            }
        ...
        },
        {
            ...
            value: (A = p(function*() {
                var e = this, t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
                if (lc(this._callMachineInitialized, "startScreenShare()"), t.screenVideoSendSettings && this._validateVideoSendSettings("screenVideo", t.screenVideoSendSettings), t.mediaStream && (this._sharedTracks.screenMediaStream = t.mediaStream, t.mediaStream = ls), "undefined" != typeof DailyNativeUtils && void 0 !== DailyNativeUtils.isIOS && DailyNativeUtils.isIOS) {
        ...
        },
        {
            key: "stopScreenShare",
            value: function() {
                lc(this._callMachineInitialized, "stopScreenShare()"), this.sendMessageToCallMachine({
        ...
        },
        {
            ...
            value: function() {
                ...
                this.sendMessageToCallMachine(Va({
        ...
        },
        {
            ...
            value: function(e) {
                e.camSimulcastEncodings && (console.warn("camSimulcastEncodings is deprecated. Use sendSettings, found in DailyCallOptions, to provide camera simulcast settings."), this.validateSimulcastEncodings(e.camSimulcastEncodings)), e.screenSimulcastEncodings && console.warn("screenSimulcastEncodings is deprecated. Use sendSettings, found in DailyCallOptions, to provide screen simulcast settings."), Es() && e.noAutoDefaultDeviceChange && console.warn("noAutoDefaultDeviceChange is not supported on Android, and will be ignored.");
            }
        },
        {
            ...
            value: function(e) {
                ...
                if (e) {
                    ...
                    if (!Ac(e.length, 1, 3)) throw new Error("encodings must be an Array with between 1 to ".concat(3, " layers"));
                    for(var r = 0; r < e.length; r++){
                        var i = e[r];
                        for(var o in this._validateEncodingLayerHasValidProperties(i), i)if (Ya.includes(o)) {
                            if ("number" != typeof i[o]) throw new Error("".concat(o, " must be a number"));
                            if (t) {
                                var s = t[o], a = s.min, c = s.max;
                                if (!Ac(i[o], a, c)) throw new Error("".concat(o, " value not in range. valid range: ").concat(a, " to ").concat(c));
                            }
                        } else if (![
                            "active",
                            "scalabilityMode"
                        ].includes(o)) throw new Error("Invalid key ".concat(o, ", valid keys are:") + Object.values(Ya));
            ...
            value: (P = p(function*(e) {
                ...
                try {
                    !function(e) {
                        ...
                        for(var t in e)if (!Xa.includes(t)) throw new Error("Invalid key ".concat(t, ", valid keys are: ").concat(Xa));
                        e.simulcastEncodings && this.validateSimulcastEncodings(e.simulcastEncodings, Ka, !0);
                    }(i);
                } catch (e) {
        ...
        },
        {
            ...
            value: function(e) {
                sc(this._callState, "startTranscription()"), this.sendMessageToCallMachine(Va({
        ...
        },
        {
            ...
            value: function(e) {
                if (sc(this._callState, "updateTranscription()"), !e) throw new Error("updateTranscription Error: options is mandatory");
        ...
        },
        {
            ...
            value: function(e) {
                if (sc(this._callState, "stopTranscription()"), e && "object" !== n(e)) throw new Error("stopTranscription Error: options must be object type");
        ...
        },
        {
            ...
            value: function(e) {
                var t = this;
                return sc(this._callState, "stopDialOut()"), new Promise(function(n, r) {
                    t.sendMessageToCallMachine(Va({
                        action: "dialout-stop"
                    }, e), function(e) {
                        e.error ? r(e.error) : n(e);
        ...
        },
        {
            ...
            value: (C = p(function*(e) {
                var t = this;
                if (sc(this._callState, "sipCallTransfer()"), !e) throw new Error("sipCallTransfer() requires a sessionId and toEndPoint");
                return e.useSipRefer = !1, Oc(e, "sipCallTransfer"), new Promise(function(n, r) {
                    t.sendMessageToCallMachine(Va({
                        action: gs
                    }, e), function(e) {
                        e.error ? r(e.error) : n(e);
        ...
        },
        {
            ...
            value: (M = p(function*(e) {
                var t = this;
                if (sc(this._callState, "sipRefer()"), !e) throw new Error("sessionId and toEndPoint are mandatory parameter");
                return e.useSipRefer = !0, Oc(e, "sipRefer"), new Promise(function(n, r) {
                    t.sendMessageToCallMachine(Va({
                        action: gs
                    }, e), function(e) {
                        e.error ? r(e.error) : n(e);
        ...
        },
        {
            ...
            value: (k = p(function*(e) {
                var t = this;
                return sc(this._callState, "sendDTMF()"), function(e) {
        ...
        },
        {
            ...
            value: function(e) {
                return e ? e instanceof MediaStreamTrack ? !!Ea(e, {
        ...
        },
        {
            ...
            value: (w = p(function*() {
                var t = this;
                hc(), dc(this._callObjectMode, "testCallQuality()"), lc(this._callMachineInitialized, "testCallQuality()", null, !0), cc(this._callState, this._isPreparingToJoin, "testCallQuality()");
                ...
                return new Promise(function(n) {
                    t.sendMessageToCallMachine({
                        ...
                        var o = i.results, s = o.result, a = e(o, Fa);
                        if ("failed" === s) {
                            var c, l = Va({}, a);
                            null !== (c = a.error) && void 0 !== c && c.details ? (a.error.details = JSON.parse(a.error.details), l.error = Va(Va({}, l.error), {}, {
                                details: Va({}, l.error.details)
                            }), l.error.details.duringTest = "testCallQuality") : (l.error = l.error ? Va({}, l.error) : {}, l.error.details = {
        ...
        },
        {
            ...
            value: function(e) {
                var t;
                if (!((null === (t = Object.keys(e)) || void 0 === t ? void 0 : t.length) > 0)) throw new Error("Empty encoding is not allowed. At least one of these valid keys should be specified:" + Object.values(Ya));
            }
        },
        {
        ...
        },
        {
            ...
            value: function(e) {
                return sc(this._callState, "setSubscribeToTracksAutomatically()", "Use the subscribeToTracksAutomatically configuration property."), this._preloadCache.subscribeToTracksAutomatically = e, this.sendMessageToCallMachine({
        ...
        },
        {
            ...
            value: (m = p(function*() {
                ...
                if (this._callObjectMode) {
                    ...
                    return "Firefox" === Os() && Ps().major > 115 && Ps().major < 123 && (t = t.filter(function(e) {
        ...
        },
        {
            ...
            value: function(e) {
                var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "*";
                if (sc(this._callState, "sendAppMessage()"), JSON.stringify(e).length > this._maxAppMessageSize) throw new Error("Message data too large. Max size is " + this._maxAppMessageSize);
                return this.sendMessageToCallMachine({
                    action: "app-msg",
                    data: e,
                    to: t
        ...
        },
        {
            ...
            value: function(e) {
                return hc(), sc(this._callState, "addFakeParticipant()"), this.sendMessageToCallMachine(Va({
        ...
        },
        {
            ...
            value: function(e) {
                return pc(this._callObjectMode, "setShowNamesMode()"), hc(), e && "always" !== e && "never" !== e ? (console.error('setShowNamesMode argument should be "always", "never", or false'), this) : (this.sendMessageToCallMachine({
        ...
        },
        {
            ...
            value: function() {
                var e = !(arguments.length > 0 && void 0 !== arguments[0]) || arguments[0];
                return pc(this._callObjectMode, "setShowLocalVideo()"), hc(), sc(this._callState, "setShowLocalVideo()"), "boolean" != typeof e ? (console.error("setShowLocalVideo only accepts a boolean value"), this) : (this.sendMessageToCallMachine({
        ...
        },
        {
            ...
            value: function() {
                var e = !(arguments.length > 0 && void 0 !== arguments[0]) || arguments[0];
                return pc(this._callObjectMode, "setShowParticipantsBar()"), hc(), sc(this._callState, "setShowParticipantsBar()"), "boolean" != typeof e ? (console.error("setShowParticipantsBar only accepts a boolean value"), this) : (this.sendMessageToCallMachine({
        ...
        },
        {
            ...
            value: function(e) {
                return hc(), pc(this._callObjectMode, "setCustomIntegrations()"), sc(this._callState, "setCustomIntegrations()"), Ec(e) ? (this.sendMessageToCallMachine({
        ...
        },
        {
            ...
            value: function(e) {
                var t = this;
                if (hc(), pc(this._callObjectMode, "startCustomIntegrations()"), sc(this._callState, "startCustomIntegrations()"), Array.isArray(e) && e.some(function(e) {
                    return "string" != typeof e;
        ...
        },
        {
            ...
            value: function(e) {
                var t = this;
                if (hc(), pc(this._callObjectMode, "stopCustomIntegrations()"), sc(this._callState, "stopCustomIntegrations()"), Array.isArray(e) && e.some(function(e) {
                    return "string" != typeof e;
        ...
        },
        {
            ...
            value: function(e) {
                return pc(this._callObjectMode, "updateCustomTrayButtons()"), hc(), sc(this._callState, "updateCustomTrayButtons()"), Cc(e) ? (this.sendMessageToCallMachine({
                    action: "update-custom-tray-buttons",
                    btns: e
                }), this._customTrayButtons = e, this) : (console.error("updateCustomTrayButtons only accepts a dictionary of the type ".concat(JSON.stringify(ec))), this);
            }
        },
        {
            key: "theme",
        ...
        },
        {
            ...
            value: function(e) {
                var t = this;
                return pc(this._callObjectMode, "setTheme()"), new Promise(function(n, r) {
                    try {
                        t.validateProperties({
                            theme: e
                        }), t.properties.theme = Va({}, e), t.sendMessageToCallMachine({
                            action: "set-theme",
        ...
        },
        {
            ...
            value: (c = p(function*(e) {
                var t = this;
                return hc(), sc(this._callState, "setNetworkTopology()"), new Promise(function(n, r) {
                    t.sendMessageToCallMachine({
        ...
        },
        {
            ...
            value: function(e) {
                if (hc(), "number" != typeof e && !0 !== e && !1 !== e) throw new Error("argument to setShouldPlayNewParticipantSound should be true, false, or a number, but is ".concat(e));
                this.sendMessageToCallMachine({
        ...
        },
        {
            ...
            value: function(e) {
                ...
                if (null != e && null !== (t = e.dailyConfig) && void 0 !== t && t.userMediaAudioConstraints) {
                    ...
                    o.audio = (null === (r = e.inputSettings) || void 0 === r ? void 0 : r.audio) || {}, o.audio.settings = (null === (i = e.inputSettings) || void 0 === i || null === (i = i.audio) || void 0 === i ? void 0 : i.settings) || {}, o.audio.settings = Va(Va({}, o.audio.settings), e.dailyConfig.userMediaAudioConstraints), e.inputSettings = o, delete e.dailyConfig.userMediaAudioConstraints;
                }
                if (null != e && null !== (n = e.dailyConfig) && void 0 !== n && n.userMediaVideoConstraints) {
                    ...
                    c.video = (null === (s = e.inputSettings) || void 0 === s ? void 0 : s.video) || {}, c.video.settings = (null === (a = e.inputSettings) || void 0 === a || null === (a = a.video) || void 0 === a ? void 0 : a.settings) || {}, c.video.settings = Va(Va({}, c.video.settings), e.dailyConfig.userMediaVideoConstraints), e.inputSettings = c, delete e.dailyConfig.userMediaVideoConstraints;
                }
                for(var l in e){
                    if (!nc[l]) throw new Error("unrecognized property '".concat(l, "'"));
                    if (nc[l].validate && !nc[l].validate(e[l], this)) throw new Error("property '".concat(l, "': ").concat(nc[l].help));
                }
            }
        },
        {
            ...
            value: function() {
                var e, t, n = Va(Va({}, this.properties), {}, {
                ...
                return n.url + r + Object.keys(nc).filter(function(e) {
                    return nc[e].queryString && void 0 !== n[e];
                }).map(function(e) {
                    return "".concat(nc[e].queryString, "=").concat(n[e]);
                }).join("&");
            }
        },
        {
            ...
            value: function(t) {
                switch(t.action){
                    ...
                    case uo:
                        ...
                        if (t.participant && t.participant.session_id) {
                            ...
                            if (this._callObjectMode) {
                                ...
                                ua(t.participant, s), da(t.participant, s), ha(t.participant, this._participants[o], s);
                            }
                            try {
                            ...
                            this.compareEqualForParticipantUpdateEvent(t.participant, this._participants[o]) || (this._participants[o] = Va({}, t.participant), this.toggleParticipantAudioBasedOnNativeAudioFocus(), this.emitDailyJSEvent(t));
                        }
                        break;
                    case po:
                        if (t.participant && t.participant.session_id) {
                    ...
                    case go:
                        ...
                        this._meetingSessionState = jc(t.meetingSessionState, this._callObjectMode), (this._callObjectMode || k) && this.emitDailyJSEvent(t);
                        break;
                    case Ro:
        ...
        },
        {
            ...
            value: function(e) {
                ...
                if (e !== this._callState || t !== this._isPreparingToJoin) {
                    ...
                    var o = ac(n, r), s = ac(this._callState, this._isPreparingToJoin);
        ...
        },
        {
            ...
            value: function() {
                this._participants = {}, this._participantCounts = Qa, this._waitingParticipants = {}, this._activeSpeaker = {}, this._activeSpeakerMode = !1, this._didPreAuth = !1, this._accessState = {
                    access: Oi
                }, this._finalSummaryOfPrevSession = this._meetingSessionSummary, this._meetingSessionSummary = {}, this._meetingSessionState = jc(Ga, this._callObjectMode), this._isScreenSharing = !1, this._receiveSettings = {}, this._inputSettings = void 0, this._sendSettings = {}, this._localAudioLevel = 0, this._isLocalAudioLevelObserverRunning = !1, this._remoteParticipantsAudioLevel = {}, this._isRemoteParticipantsAudioLevelObserverRunning = !1, this._maxAppMessageSize = rs, this._callMachineInitialized = !1, this._bundleLoadTime = void 0, this._preloadCache;
            }
        },
        {
        ...
        },
        {
            ...
            value: function() {
                for(var e = 0, t = Object.values(za); e < t.length; e++){
                    var n = t[e];
        ...
        },
        {
            ...
            value: function(e) {
                var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
                if (hc(), !e || !e.contentWindow || "string" != typeof e.src) throw new Error("DailyIframe::Wrap needs an iframe-like first argument");
        ...
        },
        {
            ...
            value: function(e, t) {
                var n, i;
                hc(), e && t ? (n = e, i = t) : e && e.append ? (n = e, i = {}) : (n = document.body, i = e || {});
                var o = i.iframeStyle;
                o || (o = n === document.body ? {
                    position: "fixed",
    ...
    //TURBOPACK unreachable
    ;
    var i, c, d, h, v, g, m, y, b, _, w, S, k, M, C, E, T, O, P, A, j, I, L, D, R, F, B, U, V, J, $, q, z, W, H, G, Y, ee;
}();
function oc(e, t) {
    var n = {};
...
function yc(e, t, n) {
    var r, i = [];
    e.video && e.video.processor && (ks(null !== (r = null == t ? void 0 : t.useLegacyVideoProcessor) && void 0 !== r && r) || (e.video.settings ? delete e.video.processor : delete e.video, i.push("video")));
    e.audio && e.audio.processor && (Ms() || (e.audio.settings ? delete e.audio.processor : delete e.audio, i.push("audio"))), i.length > 0 && console.error("Ignoring settings for browser- or platform-unsupported input processor(s): ".concat(i.join(", "))), e.audio && e.audio.settings && (e.audio.settings.customTrack ? (n.audioTrack = e.audio.settings.customTrack, e.audio.settings = {
        customTrack: ls
            ...
            switch(e){
                ...
                case us.BGIMAGE:
                    return !(void 0 !== t.source && !function(e) {
                        ...
                        }(e.source) || (console.error("invalid image type; supported types: [".concat(hs.join(", "), "]")), !1);
...
function Cc(e) {
    if (e && "object" !== n(e) || Array.isArray(e)) return console.error("customTrayButtons should be an Object of the type ".concat(JSON.stringify(ec), ".")), !1;
    if (e) for(var t = 0, r = Object.entries(e); t < r.length; t++)for(var i = f(r[t], 1)[0], o = 0, s = Object.entries(e[i]); o < s.length; o++){
        var a = f(s[o], 2), c = a[0], l = a[1], u = ec.id[c];
...
function Ec(e) {
    if (!e || e && "object" !== n(e) || Array.isArray(e)) return console.error(Mc()), !1;
    for(var t = function(e) {
        return "".concat(e, " should be ").concat(tc.id[e]);
    }, r = function(e, t) {
        ...
        for(var a = 0, c = Object.entries(e[s]); a < c.length; a++){
            ...
            switch(u){
                ...
                case "shared":
                    ...
                    break;
                default:
                    if (!tc.id[u]) return console.error("customIntegration does not support key ".concat(u)), !1;
            }
        }
    }
    return !0;
...
function Tc(e, t) {
    ...
    switch(n(t)){
        ...
        case "object":
            if ("object" !== n(e)) return !1;
            for(var r in e)if (!Tc(e[r], t[r])) return !1;
            return !0;
        default:
            return !1;
    }
...
function Pc(e) {
    ...
    if (e.state && !Object.values(ps).includes(e.state)) throw new Error("Invalid value for RemoteMediaPlayerSettings.state, valid values are: " + JSON.stringify(ps));
    if (e.volume) {
...
"[project]/node_modules/@pipecat-ai/small-webrtc-transport/dist/index.module.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "DailyMediaManager",
    ()=>$22ece045290c996a$export$c95c65abc5f47125,
    "SmallWebRTCTransport",
    ()=>$b31644dc78dca54a$export$62043589d053a879,
    "WavMediaManager",
    ()=>$fc49a56cd8739127$export$45c5b9bfba2f6304
]);
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$small$2d$webrtc$2d$transport$2f$node_modules$2f40$daily$2d$co$2f$daily$2d$js$2f$dist$2f$daily$2d$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@pipecat-ai/small-webrtc-transport/node_modules/@daily-co/daily-js/dist/daily-esm.js [app-client] (ecmascript)");
;
;
...
var $fc49a56cd8739127$export$45c5b9bfba2f6304 = /** @class */ function(_super) {
    ...
    WavMediaManager.prototype._handleDeviceError = function(_a) {
        ...
        var deviceError = new (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$client$2d$js$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DeviceError"])(devices, type, error === null || error === void 0 ? void 0 : error.message, error ? {
            sourceError: error
        } : undefined);
...
var $22ece045290c996a$export$c95c65abc5f47125 = /** @class */ function(_super) {
    ...
    function DailyMediaManager(enablePlayer, enableRecording, onTrackStartedCallback, onTrackStoppedCallback, recorderChunkSize, recorderSampleRate, playerSampleRate) {
        ...
        _this._recorderChunkSize = recorderChunkSize;
        _this._daily = (_a = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$small$2d$webrtc$2d$transport$2f$node_modules$2f40$daily$2d$co$2f$daily$2d$js$2f$dist$2f$daily$2d$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]).getCallInstance()) !== null && _a !== void 0 ? _a : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$small$2d$webrtc$2d$transport$2f$node_modules$2f40$daily$2d$co$2f$daily$2d$js$2f$dist$2f$daily$2d$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]).createCallObject();
        ...
        var generateDeviceError = function(error) {
            ...
            switch(error.type){
                case "permissions":
                    ...
                    return new (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$client$2d$js$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DeviceError"])(devices, error.type, error.msg, {
                ...
                case "cam-in-use":
                    devices.push("cam");
                    return new (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$client$2d$js$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DeviceError"])(devices, "in-use", error.msg);
                case "mic-in-use":
                    devices.push("mic");
                    return new (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$client$2d$js$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DeviceError"])(devices, "in-use", error.msg);
                case "cam-mic-in-use":
...
class $b31644dc78dca54a$export$62043589d053a879 extends (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$client$2d$js$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Transport"]) {
    constructor(opts = {}){
        super();
        ...
        if (opts.connectionUrl) (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$client$2d$js$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"]).warn("connectionUrl is deprecated, use webrtcUrl instead");
        this.mediaManager = opts.mediaManager || new (0, $22ece045290c996a$export$c95c65abc5f47125)(false, false, async (event)=>{
            if (!this.pc) return;
            if (event.type == "audio") {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$client$2d$js$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"]).info("SmallWebRTCMediaManager replacing audio track");
                await this.getAudioTransceiver().sender.replaceTrack(event.track);
            } else if (event.type == "video") {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$client$2d$js$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"]).info("SmallWebRTCMediaManager replacing video track");
                await this.getVideoTransceiver().sender.replaceTrack(event.track);
            }
        }, (event)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$client$2d$js$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"]).debug("SmallWebRTCMediaManager Track stopped:", event));
    }
    initialize(options, messageHandler) {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$client$2d$js$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"]).debug("[RTVI Transport] Initialized");
    }
    async initDevices() {
    ...
    _validateConnectionParams(connectParams) {
        ...
        if (typeof connectParams !== "object") throw new (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$client$2d$js$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RTVIError"])("Invalid connection parameters");
        ...
        for (const [key, val] of Object.entries(connectParams)){
            ...
            if (camelKey !== "webrtcUrl" && camelKey !== "connectionUrl") throw new (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$client$2d$js$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RTVIError"])(`Unrecognized connection parameter: ${key}. Only 'webrtcUrl' or 'connectionUrl' are allowed.`);
            else if (typeof val !== "string") throw new (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$client$2d$js$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RTVIError"])(`Invalid type for ${key}: expected string, got ${typeof val}`);
            if (camelKey === "connectionUrl") (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$client$2d$js$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"]).warn("connectionUrl is deprecated, use webrtcUrl instead");
    ...
    async _connect(connectParams) {
        ...
        this._webrtcUrl = connectParams?.webrtcUrl ?? connectParams?.connectionUrl ?? this._webrtcUrl;
        if (!this._webrtcUrl) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$client$2d$js$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"]).error("No url provided for connection");
            this.state = "error";
            throw new (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$client$2d$js$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TransportStartError"])();
        }
    ...
    sendReadyMessage() {
        ...
        this.sendMessage((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$client$2d$js$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RTVIMessage"]).clientReady());
    }
    sendMessage(message) {
        if (!this.dc || this.dc.readyState !== "open") {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$client$2d$js$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"]).warn(`Datachannel is not ready. Message not sent: ${message}`);
            return;
        }
    ...
    createPeerConnection() {
        ...
        pc.addEventListener("icegatheringstatechange", ()=>{
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$client$2d$js$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"]).debug(`iceGatheringState: ${this.pc.iceGatheringState}`);
        });
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$client$2d$js$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"]).debug(`iceGatheringState: ${pc.iceGatheringState}`);
        pc.addEventListener("iceconnectionstatechange", ()=>this.handleICEConnectionStateChange());
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$client$2d$js$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"]).debug(`iceConnectionState: ${pc.iceConnectionState}`);
        pc.addEventListener("signalingstatechange", ()=>{
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$client$2d$js$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"]).debug(`signalingState: ${this.pc.signalingState}`);
            if (this.pc.signalingState == "stable") this.handleReconnectionCompleted();
        });
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$client$2d$js$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"]).debug(`signalingState: ${pc.signalingState}`);
        pc.addEventListener("track", (evt)=>{
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$client$2d$js$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"]).debug(`Received new track ${evt.track.kind}`);
    ...
    handleICEConnectionStateChange() {
        if (!this.pc) return;
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$client$2d$js$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"]).debug(`ICE Connection State: ${this.pc.iceConnectionState}`);
        if (this.pc.iceConnectionState === "failed") {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$client$2d$js$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"]).debug("ICE connection failed, attempting restart.");
            this.attemptReconnection(true);
        } else if (this.pc.iceConnectionState === "disconnected") setTimeout(()=>{
            if (this.pc?.iceConnectionState === "disconnected") {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$client$2d$js$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"]).debug("Still disconnected, attempting reconnection.");
                this.attemptReconnection(true);
            }
        }, 5000);
    }
    ...
    async attemptReconnection(recreatePeerConnection = false) {
        if (this.isReconnecting) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$client$2d$js$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"]).debug("Reconnection already in progress, skipping.");
            return;
        }
        if (this.reconnectionAttempts >= this.maxReconnectionAttempts) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$client$2d$js$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"]).debug("Max reconnection attempts reached. Stopping transport.");
            await this.stop();
            return;
        }
        this.isReconnecting = true;
        this.reconnectionAttempts++;
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$client$2d$js$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"]).debug(`Reconnection attempt ${this.reconnectionAttempts}...`);
        ...
        if (recreatePeerConnection) {
            ...
            if (oldPC) {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$client$2d$js$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"]).debug("closing old peer connection");
    ...
    async negotiate(recreatePeerConnection = false) {
        ...
        try {
            ...
            // Filter audio codec
            if (this.audioCodec && this.audioCodec !== "default") offerSdp.sdp = this.sdpFilterCodec("audio", this.audioCodec, offerSdp.sdp);
            // Filter video codec
            if (this.videoCodec && this.videoCodec !== "default") offerSdp.sdp = this.sdpFilterCodec("video", this.videoCodec, offerSdp.sdp);
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$client$2d$js$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"]).debug(`Will create offer for peerId: ${this.pc_id}`);
            ...
            // @ts-ignore
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$client$2d$js$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"]).debug(`Received answer for peer connection id ${answer.pc_id}`);
            await this.pc.setRemoteDescription(answer);
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$client$2d$js$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"]).debug(`Remote candidate supports trickle ice: ${this.pc.canTrickleIceCandidates}`);
        } catch (e) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$client$2d$js$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"]).debug(`Reconnection attempt ${this.reconnectionAttempts} failed: ${e}`);
            this.isReconnecting = false;
    ...
    async addUserMedia() {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$client$2d$js$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"]).debug(`addUserMedia this.tracks(): ${this.tracks()}`);
        let audioTrack = this.tracks().local.audio;
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$client$2d$js$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"]).debug(`addUserMedia audioTrack: ${audioTrack}`);
        if (audioTrack) await this.getAudioTransceiver().sender.replaceTrack(audioTrack);
        let videoTrack = this.tracks().local.video;
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$client$2d$js$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"]).debug(`addUserMedia videoTrack: ${videoTrack}`);
    ...
    handleMessage(message) {
        try {
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$client$2d$js$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"]).debug("received message:", messageObj);
    ...
    createDataChannel(label, options) {
        ...
        dc.addEventListener("close", ()=>{
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$client$2d$js$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"]).debug("datachannel closed");
        ...
        dc.addEventListener("open", ()=>{
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$client$2d$js$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"]).debug("datachannel opened");
    ...
    async stop() {
        if (!this.pc) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$client$2d$js$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"]).debug("Peer connection is already closed or null.");
            return;
        }
    ...
    enableScreenShare(enable) {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$client$2d$js$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"]).error("startScreenShare not implemented for SmallWebRTCTransport");
        throw new Error("Not implemented");
    }
    get isSharingScreen() {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$client$2d$js$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"]).error("isSharingScreen not implemented for SmallWebRTCTransport");
        return false;
    }
...
//# sourceMappingURL=node_modules_%40pipecat-ai_small-webrtc-transport_49cbf618._.js.map