module.exports = [
"[project]/node_modules/@pipecat-ai/daily-transport/node_modules/@daily-co/daily-js/dist/daily-esm.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ms() {
    return !ys() && "undefined" != ("TURBOPACK compile-time value", "undefined") && window.navigator && window.navigator.userAgent ? "TURBOPACK unreachable" : "";
}
function ys() {
...
function Ts() {
    var e, t = ms(), n = t.match(/Mac/) && (!ys() && "undefined" != ("TURBOPACK compile-time value", "undefined") && null !== (e = window) && void 0 !== e && null !== (e = e.navigator) && void 0 !== e && e.maxTouchPoints ? "TURBOPACK unreachable" : 0) >= 5;
...
"[project]/node_modules/@pipecat-ai/daily-transport/dist/index.module.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$daily$2d$transport$2f$node_modules$2f40$daily$2d$co$2f$daily$2d$js$2f$dist$2f$daily$2d$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@pipecat-ai/daily-transport/node_modules/@daily-co/daily-js/dist/daily-esm.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$client$2d$js$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@pipecat-ai/client-js/dist/index.module.js [app-ssr] (ecmascript)");
;
;
...
class $683f111f61e07358$export$b1ca982aa1e488c1 extends (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$client$2d$js$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Transport"]) {
    constructor(opts = {}){
        super();
        this._botId = "";
        this._selectedCam = {};
        ...
        this._daily = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$daily$2d$transport$2f$node_modules$2f40$daily$2d$co$2f$daily$2d$js$2f$dist$2f$daily$2d$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"]).createCallObject({
    ...
    flushAudioQueue() {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$client$2d$js$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["logger"]).debug(`Will flush audio queue: ${this._audioQueue.length}`);
    ...
    initialize(options, messageHandler) {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$client$2d$js$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["logger"]).debug("[Daily Transport] Initialized", (0, /*@__PURE__*/ $parcel$interopDefault($58d19ff082af5e5c$exports)).version);
    }
    get dailyCallClient() {
    ...
    updateSpeaker(speakerId) {
        this._daily.setOutputDeviceAsync({
            ...
            this._callbacks.onDeviceError?.(new (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$client$2d$js$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DeviceError"])([
                "speaker"
    ...
    async startRecording() {
        try {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$client$2d$js$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["logger"]).info("[Daily Transport] Initializing recording");
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$client$2d$js$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["logger"]).info("[Daily Transport] Recording Initialized");
        } catch (e) {
            const err = e;
            if (!err.message.includes("Already recording")) (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$client$2d$js$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["logger"]).error("Error starting recording", e);
        }
    }
    ...
    async initDevices() {
        if (!this._daily) throw new (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$client$2d$js$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["RTVIError"])("Transport instance not initialized");
    ...
    _validateConnectionParams(connectParams) {
        ...
        if (typeof connectParams !== "object") throw new (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$client$2d$js$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["RTVIError"])("Invalid connection parameters");
    ...
    async _connect(connectParams) {
        ...
        try {
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$client$2d$js$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["logger"]).error("Failed to join room", e);
            this.state = "error";
            throw new (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$client$2d$js$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["TransportStartError"])();
        }
    ...
    async sendReadyMessage() {
        return new Promise((resolve)=>{
            ...
            const sendReadyMessage = ()=>{
                ...
                this.sendMessage((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$client$2d$js$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["RTVIMessage"]).clientReady());
                this.stopRecording();
                resolve();
            };
            ...
            const readyHandler = (ev)=>{
                if (!ev.participant?.local) {
                    ...
                    if (isIOS()) {
                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$client$2d$js$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["logger"]).debug("[Daily Transport] iOS device detected, adding 0.5 second delay before sending ready message");
        ...
        const generateDeviceError = (error)=>{
            ...
            switch(error.type){
                case "permissions":
                    ...
                    return new (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$client$2d$js$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DeviceError"])(devices, error.type, error.msg, {
                ...
                case "cam-in-use":
                    devices.push("cam");
                    return new (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$client$2d$js$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DeviceError"])(devices, "in-use", error.msg);
                case "mic-in-use":
                    devices.push("mic");
                    return new (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$client$2d$js$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DeviceError"])(devices, "in-use", error.msg);
                case "cam-mic-in-use":
    ...
    async handleLocalAudioTrack(track) {
        ...
        switch(status){
            ...
            default:
                ...
                else (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$client$2d$js$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["logger"]).warn("track-started event received for current track and already recording");
                break;
        }
    ...
    handleFatalError(ev) {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$client$2d$js$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["logger"]).error("Daily fatal error", ev.errorMsg);
        this.state = "error";
        this._botId = "";
        this._callbacks.onError?.((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$pipecat$2d$ai$2f$client$2d$js$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["RTVIMessage"]).error(ev.errorMsg, true));
    }
...
//# sourceMappingURL=node_modules_%40pipecat-ai_daily-transport_04b8fd5a._.js.map